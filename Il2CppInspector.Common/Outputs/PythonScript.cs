...
namespace Il2CppInspector.Outputs
{
    public class PythonScript
    {
        ...
        private void writeTypes(string typeHeaderFile) => new CppScaffolding(model, includeImgui: false, includeIl2cppResolver: false, useBetterArraySize: true).WriteTypes(typeHeaderFile);
